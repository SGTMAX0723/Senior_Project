...
function page() {
  return (
    <div className='grid grid-cols-1 gap-10 place-items-center '>
        ...
        <p>Enter your email and we'll send you a email reset link</p>
        ...
        <label className="sr-only">Passowrd</label>
        <input name="passwrod" type="password" className=" w-96  grid justify-items-stretch justify-self-center appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Password"></input>
